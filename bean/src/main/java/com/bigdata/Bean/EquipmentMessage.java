...
public class EquipmentMessage {
    ...
    public EquipmentMessage(int id, int equipmentType, String area, String addr, int temperature, int temperatureLevel,
                            int pressure, int pressureLevel, int flow, int flowLevel, long time) {
        this.id = id;
